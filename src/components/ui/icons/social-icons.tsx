...
function SvgMarca({ children, ...props }: PropiedadesIcono & { children: ReactNode }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export const REDES_SOCIALES_DISPONIBLES: readonly {
  ...
  { plataforma: "instagram", etiqueta: "Instagram", placeholder: "https://instagram.com/usuario" },
  { plataforma: "facebook", etiqueta: "Facebook", placeholder: "https://facebook.com/pagina" },
  { plataforma: "whatsapp", etiqueta: "WhatsApp", placeholder: "https://wa.me/5493810000000" },
  { plataforma: "youtube", etiqueta: "YouTube", placeholder: "https://youtube.com/@canal" },
  { plataforma: "tiktok", etiqueta: "TikTok", placeholder: "https://tiktok.com/@usuario" },
  { plataforma: "x", etiqueta: "X", placeholder: "https://x.com/usuario" },
  { plataforma: "linkedin", etiqueta: "LinkedIn", placeholder: "https://linkedin.com/company/empresa" },
  { plataforma: "pinterest", etiqueta: "Pinterest", placeholder: "https://pinterest.com/usuario" },
  { plataforma: "threads", etiqueta: "Threads", placeholder: "https://threads.net/@usuario" },
  { plataforma: "telegram", etiqueta: "Telegram", placeholder: "https://t.me/usuario" },
  { plataforma: "discord", etiqueta: "Discord", placeholder: "https://discord.gg/invitacion" },
  { plataforma: "twitch", etiqueta: "Twitch", placeholder: "https://twitch.tv/canal" },
  { plataforma: "snapchat", etiqueta: "Snapchat", placeholder: "https://snapchat.com/add/usuario" },
] as const

const ICONOS_REDES: Record<PlataformaSocial, (props: PropiedadesIcono) => ReactNode> = {
