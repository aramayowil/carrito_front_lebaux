    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-sm">
        <DialogHeader className="items-center text-center">
          ...
          <DialogTitle className="text-xl">Pedido listo para enviar</DialogTitle>
          <DialogDescription>Abrimos WhatsApp con el detalle. Revisalo y presioná enviar para confirmar la consulta.</DialogDescription>
        </DialogHeader>
        <DialogFooter>
          <Button
            className="w-full"
